...
from .is_video_playing import isVideoPlaying
...
class VideoPlayer:
    ...
    def show_all_videos(self):
        ...
        for video in sorted(self._video_library._videos.values(), key=lambda vid: vid.title):
    ...
    def play_video(self, video_id):
        ...
        for video in self._video_library._videos.values():
            valid_video_ids.append(video.video_id)
